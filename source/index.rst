...
4. **Applied mathematics in Python:** This chapter covers Python libraries to solve engineering and management problems using Python.
5. **Structured Query Language (SQL):** Here you will learn how to use the SQL language to query data in a database. This is a very powerful language, and although there are many different flavours and variations, most database engines used in in one way or another.
