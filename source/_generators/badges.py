...
import sys
import json
template_folders = ['Introduction', 'Modularization', 'Applied Mathematics', 'Data Manipulation', 'Databases', 'Extra Exercises', 'Courses Extra']
    ...
    for template_folder in template_folders:
        for template_file in pathlib.Path('../' + template_folder).glob('**/*.ipynb'):
            ...
            badges = "## Try me\\n\"," +\
                     ...
                     "[![Github](https://img.shields.io/badge/download-github-blue?logo=github)](https://github.com/{0}/raw/{1}/{2}/{3})".format(git_repo, branch, path_to_template_folders, colabs_file_name)
